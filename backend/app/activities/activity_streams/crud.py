...
def get_activity_streams(
    ...
    try:
        ...
        return [activity_streams_utils.transform_activity_streams(stream, activity, db) for stream in activity_streams]
...
def get_activities_streams(
    ...
    try:
        ...
        return [
            activity_streams_utils.transform_activity_streams(
                stream,
                activity_map[stream.activity_id],
                db,
            )
...
def get_activity_stream_by_type(
    ...
    try:
        ...
        return activity_streams_utils.transform_activity_streams(activity_stream, activity, db)
    except SQLAlchemyError as err:
        core_logger.print_to_log(
