<template>
  ...
  >
    <span
      ><b>{{
        $t('newActivityDuplicateStartTimeNotificationComponent.newActivityDuplicateStartTimeTitle')
      }}</b></span
    >
    <br />
    <span class="fw-lighter">
      {{
        $t(
          'newActivityDuplicateStartTimeNotificationComponent.newActivityDuplicateStartTimeSubTitle'
        )
      }}
    </span>
  </router-link>
