...
class TestGetSignUpTokenByHash:
    ...
    def test_get_sign_up_token_by_hash_found_returns_token(
        self, mock_db
    ):
        ...
        # Act
        result = sign_up_tokens_crud.get_sign_up_token_by_hash(
            "abc123hash", mock_db
        )
    ...
    def test_get_sign_up_token_by_hash_not_found_returns_none(
        self, mock_db
    ):
        ...
        # Act
        result = sign_up_tokens_crud.get_sign_up_token_by_hash(
            "nonexistenthash", mock_db
        )

        # Assert
        assert result is None

    def test_get_sign_up_token_by_hash_query_filters_hash(
        self, mock_db
    ):
    ...
    def test_get_sign_up_token_by_hash_query_filters_used(
        self, mock_db
    ):
    ...
    def test_get_sign_up_token_by_hash_query_filters_expiry(
        self, mock_db
    ):
...
class TestCreateSignUpToken:
    ...
    @patch(
        "sign_up_tokens.crud.sign_up_tokens_models.SignUpToken"
    )
    def test_create_sign_up_token_persists_and_returns_token(
        self, mock_model_class, mock_db
    ):
        ...
        # Act
        result = sign_up_tokens_crud.create_sign_up_token(
...
class TestMarkSignUpTokenUsed:
    ...
    def test_mark_sign_up_token_used_sets_used_true(
        self, mock_db
    ):
        ...
        # Act
        result = sign_up_tokens_crud.mark_sign_up_token_used(
            "some-token-id", mock_db
        )
    ...
    def test_mark_sign_up_token_used_not_found_returns_none(
        self, mock_db
    ):
    ...
    def test_mark_sign_up_token_used_query_filters_by_id(
        self, mock_db
    ):
...
class TestDeleteExpiredSignUpTokens:
    ...
    def test_delete_expired_sign_up_tokens_returns_rowcount(
        self, mock_db
    ):
        ...
        # Act
        result = sign_up_tokens_crud.delete_expired_sign_up_tokens(
            mock_db
        )
    ...
    def test_delete_expired_sign_up_tokens_zero_returns_zero(
        self, mock_db
    ):
    ...
    def test_delete_expired_sign_up_tokens_query_filters_expiry(
        self, mock_db
    ):
        ...
        assert any(
            criterion.left.name == "expires_at"
            and criterion.operator is operators.lt
            for criterion in criteria
        )
